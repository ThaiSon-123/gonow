                ...
                <div class="col col-small" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <div class="footer-widget footer-links">
                        ...
                        <ul class="list-style-three">
                            <li><a href="{{ route('tours') }}">Hướng dẫn viên du lịch tốt nhất</a></li>
                ...
                <div class="col col-md-6 col-10 col-small" data-aos="fade-up" data-aos-delay="200"
                    ...
                    <div class="footer-widget footer-contact">
                        ...
                        <ul class="list-style-one">
                            <li><i class="fal fa-map-marked-alt"></i> 06 Trần Văn Ơn, Phú Hoà, Thủ Dầu Một, Bình Dương</li>
                            <li><i class="fal fa-envelope"></i> <a
                                    href="mailto:210son116@gmail.com">210son116@gmail.com</a></li>
                            <li><i class="fal fa-clock"></i> Thứ 2 - Thứ 6</li>
                            <li><i class="fal fa-phone-volume"></i> <a href="callto:0829999326">0829999326</a></li></a></li>
                        </ul>
                    </div>
                </div>
            </div>
