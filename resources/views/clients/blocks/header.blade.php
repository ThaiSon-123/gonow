...
<head>
    ...
    <!-- login -->
    <!-- Font Icon -->
    <link rel="stylesheet" href="clients/assets/css/css-login/fonts/material-icon/css/material-design-iconic-font.min.css">
    <!-- Main css -->
    <link rel="stylesheet" href="clients/assets/css/css-login/style.css">
                ...
                <div class="container-fluid clearfix">
                    ...
                    <div class="header-inner rel d-flex align-items-center">
                        <div class="logo-outer">
                            <div class="logo"><a href="{{ route('home') }}"><img src="clients/assets/images/logos/logo-two.png"
                            ...
                            <nav class="main-menu navbar-expand-lg">
                                <div class="navbar-header">
                                    <div class="mobile-logo">
                                        <a href="{{ route('home') }}">
                                            <img src="clients/assets/images/logos/logo-two.png" alt="Logo" title="Logo">
                                        </a>
                                    </div>
