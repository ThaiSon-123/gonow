        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="section-title text-white text-center counter-text-wrap mb-70" data-aos="fade-up"
                    ...
                    <h2>Khám phá kho báu Việt Nam cùng GoNow</h2>
                    <p>Một website <span class="count-text plus" data-speed="3000" data-stop="30000">0</span> trải nghiệm
                        phổ biến nhất
                        bạn sẽ nhớ mãi</p>
                </div>
            </div>
            ...
            @foreach ($tours as $tour)
                <div class="col-xxl-3 col-xl-4 col-md-6">
                    <div class="destination-item block_tours" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <div class="image">
                            <div class="ratting"><i class="fas fa-star"></i> 4.5</div>
                            <a href="#" class="heart"><i class="fas fa-heart"></i></a>
                            <img src="clients/assets/images/gallery-tours/{{ $tour->images[0] }}" alt="Destination">
                        </div>
                        <div class="content">
        ...
        <div class="row align-items-center">
            <div class="col-xl-5 col-lg-6">
                <div class="about-us-content rmb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                    ...
                    <p>Chúng tôi luôn nỗ lực hết mình để biến ước mơ du lịch của bạn thành hiện thực với những điểm đến
                        tuyệt vời và những trải nghiệm không thể bỏ qua
                    </p>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-md-6" data-aos="zoom-in-down" data-aos-delay="50" data-aos-duration="1500"
                ...
                <div class="cta-item" style="background-image: url(clients/assets/images/cta/cta2.jpg);">
                    <span class="category">Bãi biển Nha Trang</span>
