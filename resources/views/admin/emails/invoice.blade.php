...
<p style="font-size: 16px; font-family: Arial, sans-serif; color: #333;">Cảm ơn bạn đã đặt tour tại GoNow. Vui lòng xem chi tiết hóa đơn trong file đính kèm.</p>
        ...
        <section class="content invoice">
            ...
            <div class="row invoice-info" style="margin-bottom: 20px;">
                ...
                <div class="col-sm-4 invoice-col" style="font-size: 14px;">
                    Đến
                    <address>
                        <strong>Công ty GoNow</strong><br>
                        Phú Hòa, Tp. Thủ Dầu Một, Bình Dương, Việt Nam<br>
                        Phone: (84) 829 999 326<br>
                        Email: thaisonpro326@gmail.com
                    </address>
                </div>
                <br>
                <div class="col-sm-4 invoice-col" style="font-size: 14px;">
